...
void FreeplayState::changeSelection(int change) {
    curSelected += change;
...
void FreeplayState::updateSongList() {
    for (auto text : songTexts) {
        delete text;
    }
    songTexts.clear();
...
void FreeplayState::updateSongImage() {
...
void FreeplayState::loadSongJson(const std::string& songName) {
